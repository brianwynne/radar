...
const covered = (isp: string, asn: number, id: number, pools: Record<string, number>, edge: { min: number; max: number }): ResolverIspView => ({
  isp, asn, measurementId: id, covered: true, probeCount: 6, resolverCount: 9,
  platforms: { Réalta: 9 }, pools, edgeTtl: edge, apexTtl: { min: 40, max: 300 },
  honoursLowTtl: edge.max <= 60, observedAt: OBS,
  samples: [
    { probeId: 27252, resolver: '192.168.1.1', platform: 'Réalta', target: 'liveedge.rte.ie', vips: ['185.54.105.12'], apexTtl: 87, edgeTtl: edge.min, observedAt: OBS },
    { probeId: 61509, resolver: '10.0.16.2', platform: 'Réalta', target: 'liveedge.rte.ie', vips: ['185.54.104.4'], apexTtl: 298, edgeTtl: edge.max, observedAt: OBS },
  ],
});
