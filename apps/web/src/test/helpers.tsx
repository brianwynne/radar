...
export const RESOLVERS_BODY = {
  ...
  isps: [
    { isp: 'Eir', asn: 5466, measurementId: 192119190, covered: true, probeCount: 6, resolverCount: 9, ispResolverCount: 8, publicResolverCount: 1, platforms: { Réalta: 8 }, pools: { '185.54.104': 4, '185.54.105': 5 }, edgeTtl: { min: 26, max: 30 }, apexTtl: { min: 40, max: 300 }, honoursLowTtl: true, observedAt: '2026-07-20T22:00:00Z', samples: [{ probeId: 27252, resolver: '192.168.1.1', public: false, platform: 'Réalta', target: 'liveedge.rte.ie', vips: ['185.54.105.12'], apexTtl: 87, edgeTtl: 26, observedAt: '2026-07-20T22:00:00Z' }, { probeId: 999, resolver: '8.8.8.8', public: true, platform: 'Réalta', target: 'liveedge.rte.ie', vips: ['185.54.104.4'], apexTtl: 60, edgeTtl: 30, observedAt: '2026-07-20T22:00:00Z' }] },
