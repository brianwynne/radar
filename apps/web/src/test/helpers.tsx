  ...
  vi.stubGlobal(
    ...
    vi.fn(async (input: RequestInfo | URL, init?: RequestInit) => {
      ...
      if (p.endsWith('/api/v1/me')) body = principal;
        ...
        live: { slices: [
          { label: 'Eir', kind: 'eyeball', platform: 'Réalta', bps: 4e9, links: 2 },
          { label: 'Sky', kind: 'eyeball', platform: 'Réalta', bps: 2e9, links: 1 },
          { label: 'INEX', kind: 'ix', platform: 'Réalta', bps: 2e9, links: 2 },
