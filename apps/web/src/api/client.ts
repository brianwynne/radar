...
import type {
  ...
  SaChannelsResponse,
  TsConnectionInput,
  TsConnectionResponse,
  TsConnectionTestResponse,
  TsDeliveryResponse,
  TsHistoryResponse,
  TsStatusResponse,
...
export const api = {
  ...
  tsConnection: () => request<TsConnectionResponse>('/api/v1/touchstream/connection'),
  tsConnectionUpdate: (body: TsConnectionInput) => request<TsConnectionResponse>('/api/v1/touchstream/connection', { method: 'PUT', body: JSON.stringify(body) }),
  tsConnectionTest: () => request<TsConnectionTestResponse>('/api/v1/touchstream/connection/test', { method: 'POST' }),
